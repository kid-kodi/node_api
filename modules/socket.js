...
module.exports = (io) => {
  io.on("connection", (socket) => {
    ...
    socket.on("send_message", (data) => {
      console.log("send_message", data.chat);
      data.chat.users.forEach((userId) => {
        io.to(userId).emit("send_message", data);
      });
      //   sendNotification(data);
    });
